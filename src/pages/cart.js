                    ...
                    <td>
                      <div class="input-group mb-3" style={{maxwidth: "120px"}}>
                        ...
                        <div class="input-group-append">
                          <button class="btn btn-outline-dark js-btn-plus" type="button">+</button>
                        </div>
                      </div>
          ...
          <div class="col-md-6 pl-5">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn btn-secondary btn-lg py-3 btn-block" onclick="window.location='checkout.html'">Proceed To Checkout</button>
                  </div>
                </div>
              </div>
            </div>
